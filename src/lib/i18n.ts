...
export const copy = {
  ...
  disclaimer: {
    zh: "本工具以積金局基金平台公開數據（截至 {asOf}）及公開市場指數作分析，並非投資建議、亦非積金局或任何受託人官方產品。強積金表現可升可跌，過往回報並不代表將來表現。轉會或轉換基金前請細閱計劃文件。",
    en: "Built from the MPFA Fund Platform (as of {asOf}) and public market indices. Not investment advice and not an official MPFA or trustee product. Past performance is not a guide to the future.",
  },
} as const;
